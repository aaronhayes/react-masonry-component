...
function MasonryComponent(React, ReactDOM) {
    return React.createClass({
        ...
        initializeMasonry: function(force) {
            if (!this.masonry || force) {
                this.masonry = new Masonry(
                    React.findDOMNode ? ReactDOM.findDOMNode(this.refs[refName]) : (this.refs[refName] || nullNode),
                    this.props.options
                );
        ...
        getNewDomChildren: function() {
            var node = React.findDOMNode ? ReactDOM.findDOMNode(this.refs[refName]) : (this.refs[refName] || nullNode);
